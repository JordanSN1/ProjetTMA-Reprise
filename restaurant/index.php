...
<html lang="fr">
    <head>
        ...
        <title>Tasty - Restaurant Maghrébin</title>
    </head>
    <body>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Saveurs du Maghreb</h1>
                        <h2 class="home__subtitle">Découvrez les délices de la semaine.</h2>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">Saveurs d'Afrique du Nord</h2>
                        <p class="about__description">Bienvenue dans notre restaurant, un lieu où les saveurs de l'Afrique du Nord se rencontrent pour offrir une expérience culinaire authentique et inoubliable.</p>
                        <a href="about.php" class="button">Explorer l'histoire</a>
            ...
            <section class="services section bd-container" id="services">
                <span class="section-subtitle">Offre</span>
                <h2 class="section-title">Nos services exceptionnels</h2>
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Nourriture excellente                        </h3>
                        <p class="services__description">Nous offrons à nos clients des services de qualité exceptionnelle depuis de nombreuses années, avec la meilleure et la plus délicieuse nourriture de la ville.</p>
                    </div>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <h2 class="section-title">Plat Tunisien</h2>
                ...
                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        ...
                        <a href="payement.php" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
            ...
            <section class="menu section bd-container" id="menu">
                <span class="section-subtitle">Special</span>
                <h2 class="section-title">Plat Algerien</h2>
            ...
            <section class="menu section bd-container" id="menu">
                <span class="section-subtitle">Special</span>
                <h2 class="section-title">Plat Marocain</h2>
...
<h2 class="section-title app__initial">Application disponible</h2>
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        ...
                        <p class="contact__description">Si vous souhaitez réserver une table dans notre restaurant, contactez-nous et nous vous répondrons rapidement grâce à notre service de chat disponible 24h/24 et 7j/7.</p>
                    </div>

                    <div class="contact__button">
                        <a href="contact-us.php" class="button">Contactez nous maintenant</a>
        ...
        <footer class="footer">
            <div class="footer__container">
                <div class="footer__content">
                    <a href="#" class="footer__logo">Tasty</a>
                    <span class="footer__description">Savourez l'authenticité des saveurs maghrébines dans un cadre accueillant. Notre restaurant vous propose une expérience culinaire unique, riche en arômes et en traditions.</span>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li><a href="index.php#home" class="footer__link">Accueil</a></li>
                        <li><a href="index.php#about" class="footer__link">À propos</a></li>
                        <li><a href="index.php#services" class="footer__link">Services</a></li>
                        <li><a href="index.php#menu" class="footer__link">Menu</a></li>
                        <li><a href="index.php#contact" class="footer__link">Contact</a></li>
                    </ul>
                </div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li><a href="#" class="footer__link">Réservation</a></li>
                        <li><a href="#" class="footer__link">Événements privés</a></li>
                        <li><a href="#" class="footer__link">Menu du jour</a></li>
                    </ul>
                </div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li>123 Avenue de Paris, 75001 Paris</li>
                        <li>01 23 45 67 89</li>
                        <li>contact@saveurmaghreb.com</li>
                        <li>Ouvert du Lundi au Dimanche</li>
                        <li>11h00 - 23h00</li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">© 2023 Tasty. Tous droits réservés. Réalisé avec passion</p>
        </footer>
