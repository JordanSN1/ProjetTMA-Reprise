            ...
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    ...
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Restauration rapide
                        </h3>
                        <p class="services__description">Nous offrons à nos clients des services de qualité exceptionnelle depuis de nombreuses années, avec la meilleure et la plus délicieuse nourriture de la ville.</p>
                    </div>
            ...
            <div class="footer__container bd-grid">
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li><a href="#" class="footer__link">Réservez votre place</a></li>
                    </ul>
                </div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        <li><a href="contact-us.php" class="footer__link">Contactez-nous</a></li>
                    </ul>
                </div>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li>Saveursmaghreb@gmail.com</li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">Tous droits réservés</p>
        </footer>
...
.menu__content:hover {
    ...
    box-shadow: 0px 8px 15px rgba(0, 0, 0, 0.2); /* Ajoute une ombre plus marquée */
}

/* Ajoutez une animation subtile à l'image dans le menu */
.menu__img {
    width: 170px;
    height: auto;
...
/* Ajoutez un style cohérent pour le bouton */
.menu__button {
